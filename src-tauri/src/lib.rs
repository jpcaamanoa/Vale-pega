...
pub fn run() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::get_patient_hard_delete_scope,
      commands::hard_delete_patient,
      ...
      commands::list_safety_plan_items,
      commands::add_safety_plan_item,
      commands::update_safety_plan_item,
      commands::delete_safety_plan_item,
      commands::create_library_resource,
      commands::get_library_resource,
      commands::list_library_resources,
      commands::list_archived_library_resources,
      commands::update_library_resource_metadata,
      commands::archive_library_resource,
      commands::restore_library_resource,
      commands::hard_delete_library_resource,
      commands::get_library_resource_data_url,
      commands::open_library_resource_externally,
      commands::export_library_resource,
      commands::link_library_resource_to_patient,
      commands::unlink_library_resource_from_patient,
      commands::list_patients_for_library_resource,
      commands::list_library_resources_for_patient,
